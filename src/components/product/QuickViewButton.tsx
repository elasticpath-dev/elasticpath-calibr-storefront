  ...
  return (
    <>
      <button
        onClick={handleOpen}
        className={cn(
          "inline-flex items-center justify-center gap-2 h-9 px-3 rounded-lg text-xs font-medium bg-brand-primary text-button-text hover:opacity-90 transition-opacity",
          className,
        )}
      >
        <Eye size={14} />
